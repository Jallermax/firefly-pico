...
import { buildTodoTransactionsPath, TODO_PAGE_SIZE, TODO_QUERY_TIMEOUT } from '~/utils/TodoTransactionUtils.js'
...
export default class TagRepository extends BaseRepository {
  ...
  async getTodoTransactions(tag, { page = 1, pageSize = TODO_PAGE_SIZE, showLoading = true } = {}) {
    ...
    return await axios.get(url, { showLoading, showErrorToast: false, timeout: TODO_QUERY_TIMEOUT })
  }
}
